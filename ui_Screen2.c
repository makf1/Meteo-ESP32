...
void ui_Screen2_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Screen2_Chart_CO2, 170);
    lv_obj_set_height(ui_Screen2_Chart_CO2, 130);
    lv_obj_set_x(ui_Screen2_Chart_CO2, 0);
    lv_obj_set_y(ui_Screen2_Chart_CO2, 20);
    ...
    lv_obj_set_width(ui_Screen2_Panel1, 240);
    ...
    lv_obj_set_y(ui_Screen2_Label2, -100);
    lv_obj_set_align(ui_Screen2_Label2, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Screen2_Label2, "CO2");
    lv_obj_set_style_text_font(ui_Screen2_Label2, &lv_font_montserrat_24, LV_PART_MAIN | LV_STATE_DEFAULT);
